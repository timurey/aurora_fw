...
typedef enum parserFlags{
   EDITEBLE =        0b00000001,
   CREATEBLE =       0b00000010,
   CONFIGURE_Path =  0b00000100,
   RESTv1Path =      0b00001000,
   RESTv2Path =      0b00010000
}parserFlags;

#define JSONPATH CONFIGURE_Path|RESTv1Path|RESTv2Path
#define EDITMODE EDITEBLE
#define CREATEMODE CREATEBLE
typedef enum
{
   CONFIGURE_MODE =CONFIGURE_Path | CREATEBLE, //We can't edit existing sensors, using config-style paths
   RESTv1POST = RESTv1Path | CREATEBLE, //We can't edit existing sensors, using RESTv1-style paths
   ...
   RESTv2POST = RESTv2Path | CREATEBLE, //We can't edit existing sensors, using RESTv2-style paths
   RESTv2PUT = EDITEBLE | RESTv2Path, //We can edit existing sensors, use RESTv2-style path
   RESTv2PATCH = EDITEBLE | RESTv2Path, //We can edit existing sensors, use RESTv2-style path
}configMode;
